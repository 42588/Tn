...
| app 菜单(点 logo · 会话/文件/设置) | [panels/01](../design/panels/01-window-chrome.html) | [workspace.rs](../crates/tn-ui/src/workspace.rs) `render_app_menu` ✅(品牌可点弹 popup + 点外关闭 + caret 开态;11 项接真实动作:命令面板/新标签/打开文件夹[选目录重定根树]/资源管理器显示/文件浏览器/设置/主题/重载/关于/退出) |
