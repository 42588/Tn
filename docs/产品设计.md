...
| 面板 | 原型 | 实现 |
|---|---|---|
| Agent 面板(头 + 用量环 + 工具流 + 气泡) | [panels/02](../design/panels/02-workspace-panes.html) | [terminal_view/header.rs](../crates/tn-ui/src/terminal_view/header.rs) `render_agent_header` |
