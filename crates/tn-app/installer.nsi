...
Section Install
  ...
  ; Register Win+R shortcut
  WriteRegStr SHCTX "Software\Microsoft\Windows\CurrentVersion\App Paths\tn.exe" "" "$INSTDIR\tn.exe"
  WriteRegStr SHCTX "Software\Microsoft\Windows\CurrentVersion\App Paths\tn.exe" "Path" "$INSTDIR"

  ; Register autostart on startup (silent mode)
  WriteRegStr SHCTX "Software\Microsoft\Windows\CurrentVersion\Run" "Tn" '"$INSTDIR\tn.exe" --startup'
...
Section Uninstall
  ...
  ; Clean up Win+R shortcut and autostart registration
  DeleteRegKey SHCTX "Software\Microsoft\Windows\CurrentVersion\App Paths\tn.exe"
  DeleteRegValue SHCTX "Software\Microsoft\Windows\CurrentVersion\Run" "Tn"
